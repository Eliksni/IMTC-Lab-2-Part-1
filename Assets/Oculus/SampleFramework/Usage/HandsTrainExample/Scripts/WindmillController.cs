...
namespace OculusSampleFramework
{
    ...
    {
        [SerializeField] public GameObject _startStopButton = null;
        [SerializeField] public GameObject _startStopButtonControlBox = null;
        ...
        private void OnEnable()
        {
            ...
            _startStopButtonControlBox.GetComponent<Interactable>().InteractableStateChanged.AddListener(StartStopStateChanged);
        }
        ...
        private void OnDisable()
        {
            if (_startStopButton != null)
            {
                ...
                _startStopButtonControlBox.GetComponent<Interactable>().InteractableStateChanged
                    .RemoveListener(StartStopStateChanged);
            }
        }
